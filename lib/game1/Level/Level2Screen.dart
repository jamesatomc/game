...
import 'package:game_somo/game1/utils/game_utils2.dart';
...
class _Level2ScreenState extends State<Level2Screen> {
  ...
  void initState() {
    ...
    // Hide all cards initially and start the timer
    setState(() {
  ...
  Future<void> _saveHighScore() async {
    ...
    if (score > level2HighScore) {
      ...
      setState(() {
        level2HighScore = score.toInt(); // บันทึก high score ลงตัวแปร level2HighScore
      });
    }
  }
              ...
              onPressed: () {
                if (score >= 4) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                        content: Text(
                            'You need at least 4 points to proceed to Level 3.')),
                  );
                }
              },
            ),
  ...
  void playMatchSound() async {
    await _audioPlayer.play(AssetSource(
        'audio/correct.mp3')); // Adjust the path to your sound file
  }

  // Method to play card mismatch sound
  void playCardMismatchSound() async {
    await _audioPlayer.play(AssetSource(
        'audio/wrong-buzzer.mp3')); // Adjust the path to your sound file
  }
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // info_card(
                  //   "High Score",
                  //   "$level2HighScore", // แสดง high score ของ Level 1
